    ...
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="shrink-0 flex items-center gap-1.5 mb-3 overflow-x-auto pb-1" style={{ scrollbarWidth: 'none' }}>
        {crates.map((crate) => (
          <button
            ...
            className={`text-[11px] font-bold uppercase tracking-[0.1em] px-3 py-1.5 border whitespace-nowrap ${
        ...
        <button className="text-[11px] font-bold uppercase tracking-[0.1em] px-3 py-1.5 border border-dashed border-waxe-border text-waxe-text-muted hover:text-waxe-text whitespace-nowrap">
          + New Crate
        </button>
      </div>
      ...
      <div className="flex-1 min-h-0 relative">
        ...
        {selectedRecords.size > 0 && (
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex items-center gap-3 bg-waxe-card border-2 border-waxe-border shadow-xl px-5 py-3 clip-card">
            ...
            <button
              ...
              onClick={() => { setSelectedRecords(new Set()); setLastClickedIndex(null) }}
            >
              Clear
            </button>
          </div>
      ...
      {selectedRecord && (() => {
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-[3vh]">
          ...
          <div className="relative w-full max-w-2xl h-[90vh] flex flex-col bg-waxe-base border-2 border-waxe-border rounded-none shadow-xl clip-modal overflow-hidden">
            ...
            {detailMode === 'view' ? (
              <>
                ...
                <div className="shrink-0 relative h-44 overflow-hidden" style={{ background: selectedRecord.photoColor || autoColor(selectedRecord.artist + selectedRecord.title) }}>
                  {selectedRecord.artworkUrl ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center text-4xl font-black text-waxe-deep/20 tracking-widest">
                  ...
                  <div className="absolute bottom-4 left-5 right-5 z-10">
                    <h2 className="text-2xl font-black text-waxe-text uppercase tracking-tight leading-tight">{selectedRecord.artist}</h2>
                ...
                <div className="flex-1 min-h-0 overflow-y-auto p-5 space-y-5">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-waxe-surface/30 p-4">
                      <p className="text-[10px] font-bold text-waxe-text-muted uppercase tracking-[0.1em] mb-3">Pressing Details</p>
                    ...
                    {/* Physical Specs */}
                    <div className="bg-waxe-surface/30 p-4">
                      <p className="text-[10px] font-bold text-waxe-text-muted uppercase tracking-[0.1em] mb-3">Physical Specs</p>
                      <div className="space-y-2">
                        <div className="flex justify-between">
                  ...
                  {/* Condition */}
                  <div className="bg-waxe-surface/30 p-4">
                    <p className="text-[10px] font-bold text-waxe-text-muted uppercase tracking-[0.1em] mb-3">Condition</p>
                    <div className="grid grid-cols-2 gap-4">
                  ...
                  {/* Pricing & Market Data */}
                  <div className="bg-waxe-surface/30 p-4">
                    <p className="text-[10px] font-bold text-waxe-text-muted uppercase tracking-[0.1em] mb-3">Pricing & Market Data</p>
                    <div className="flex items-start gap-6">
                      {/* Your Price + Delta */}
                      <div>
                        <p className="text-2xl font-black text-waxe-text">${selectedRecord.price.toFixed(2)}</p>
                      ...
                      <div className="ml-auto text-right">
                        <svg width="120" height="36" viewBox="0 0 120 36" className="inline-block">
                          <polyline
                            fill="none"
                            stroke="var(--color-waxe-cool, #4A6B8A)"
                            strokeWidth="1.5"
                            points={sparkPoints}
                          />
                          <circle
              ...
              <>
                ...
                <div className="flex-1 min-h-0 overflow-y-auto p-5 space-y-5">
                  ...
                  {/* Pricing */}
                  <div className="bg-waxe-surface/30 rounded-none p-4">
                    <p className="text-[10px] font-bold text-waxe-text-muted uppercase tracking-[0.1em] mb-3">Pricing</p>
                    <div className="grid grid-cols-3 gap-4">
                      <div>
