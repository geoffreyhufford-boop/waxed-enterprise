  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <div className="lg:col-span-2 bg-waxe-card border-2 border-waxe-border rounded-none p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <p className="text-2xl font-black text-waxe-text tracking-tight">$14,230</p>
        ...
        <div className="bg-waxe-card border-2 border-waxe-border rounded-none p-5">
          <h2 className="text-[11px] font-black text-waxe-text uppercase tracking-[0.1em] mb-4">Sales <span className="text-waxe-cool">{'>>'}</span> Channel</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="lg:col-span-2 bg-waxe-card border-2 border-waxe-border rounded-none p-5">
          ...
          <div className="space-y-2">
            {topSellers.map((record, i) => (
              <div key={i} className="flex items-center gap-4 py-2.5 px-3 hover:bg-waxe-surface/30 transition-colors">
        ...
        <div className="space-y-6">
          <div className="bg-waxe-card border-2 border-waxe-border rounded-none p-5">
            <h2 className="text-[11px] font-black text-waxe-text uppercase tracking-[0.1em] mb-4">Inventory <span className="text-waxe-cool">{'>>'}</span> Alerts</h2>
            <div className="space-y-3">
              {inventoryAlerts.map((alert, i) => (
                <div key={i} className="flex items-center justify-between">
                  <span className="text-sm text-waxe-text-secondary">{alert.label}</span>
                  <div className="flex items-center gap-2">
                    <span className="text-[11px] font-black text-waxe-text uppercase tracking-[0.1em]">{alert.count}</span>
          ...
          <div className="bg-waxe-card border-2 border-waxe-border rounded-none p-5">
            <h2 className="text-[11px] font-black text-waxe-text uppercase tracking-[0.1em] mb-4">Genre <span className="text-waxe-cool">{'>>'}</span> Mix</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Activity Feed */}
        <div className="bg-waxe-card border-2 border-waxe-border rounded-none p-5">
          <h2 className="text-[11px] font-black text-waxe-text uppercase tracking-[0.1em] mb-4">Recent <span className="text-waxe-cool">{'>>'}</span> Activity</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-start gap-4 py-2 px-3 hover:bg-waxe-surface/30 transition-colors">
