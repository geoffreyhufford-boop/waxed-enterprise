  ...
  <div className="flex flex-col flex-1 min-h-0">
   ...
   <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-5 gap-4">
    ...
    <div className="lg:col-span-3 min-h-0 flex flex-col">
     ...
     {/* Storefront content */}
     <div className="flex-1 min-h-0 overflow-y-auto border border-waxe-border" style={{ background: storefrontConfig.primaryColor, color: '#111', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div className="px-6 pt-6 pb-2">
       ...
       <h1 className="font-semibolder leading-[0.85]" style={{ fontSize: 'clamp(2.5rem, 8vw, 4.5rem)', color: '#111' }}>
    ...
    <div className="lg:col-span-2 min-h-0 overflow-y-auto space-y-4">
     ...
     <div className="bg-waxe-card border border-waxe-border p-5 clip-card">
      <div className="flex items-center gap-2 mb-2">
       <h2 className="text-[11px] font-semibold text-waxe-text">Customize</h2>
      </div>
