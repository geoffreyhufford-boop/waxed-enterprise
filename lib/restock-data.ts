...
export const networkRecords: NetworkRecord[] = [
  ...
  { id: 'nr-004', artist: 'Aphex Twin', title: 'Selected Ambient Works 85-92', genre: 'Techno', condition: 5, price: 65, qty: 1, storeId: 'store-002', storeName: 'BPM Supply', storeLocation: 'Berlin, DE', format: '2x12"', year: 1992, label: 'Apollo', photoColor: '#1B2632', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/5f/b3/e0/5fb3e08d-c2cd-3da4-6ad7-c5dc61803683/cover.jpg/300x300bb.jpg' },
  { id: 'nr-005', artist: 'Jeff Mills', title: 'Waveform Transmission Vol. 1', genre: 'Techno', condition: 4, price: 120, qty: 1, storeId: 'store-002', storeName: 'BPM Supply', storeLocation: 'Berlin, DE', format: '12"', year: 1992, label: 'Tresor', photoColor: '#4A5B6D' },
  { id: 'nr-006', artist: 'Kerri Chandler', title: 'Spaces and Places', genre: 'House', condition: 5, price: 48, qty: 3, storeId: 'store-002', storeName: 'BPM Supply', storeLocation: 'Berlin, DE', format: '2x12"', year: 2022, label: 'Kaoz Theory', photoColor: '#3D7A4F', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music112/v4/14/d2/77/14d277cd-1c90-3908-9c6f-951c54f7e481/cover.jpg/300x300bb.jpg' },
  { id: 'nr-007', artist: 'Drexciya', title: 'Neptune\'s Lair', genre: 'Electro', condition: 4, price: 95, qty: 1, storeId: 'store-002', storeName: 'BPM Supply', storeLocation: 'Berlin, DE', format: '2x12"', year: 1999, label: 'Tresor', photoColor: '#2C3B4D', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music122/v4/95/a4/3f/95a43f9d-4eb9-e5a9-ee64-910d3fb95e6c/3663729188892_3000.jpg/300x300bb.jpg' },
  ...
  { id: 'nr-009', artist: 'Madlib', title: 'Shades of Blue', genre: 'Hip-Hop', condition: 3, price: 32, qty: 1, storeId: 'store-003', storeName: 'Wax Poetics', storeLocation: 'Los Angeles, CA', format: '2x12"', year: 2003, label: 'Blue Note', photoColor: '#1B2632', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music124/v4/0d/96/1d/0d961d09-8e54-e2f5-f5ce-b08690b1e797/00602537641079.rgb.jpg/300x300bb.jpg' },
  { id: 'nr-010', artist: 'D\'Angelo', title: 'Voodoo', genre: 'R&B', condition: 5, price: 45, qty: 1, storeId: 'store-003', storeName: 'Wax Poetics', storeLocation: 'Los Angeles, CA', format: '2x12"', year: 2000, label: 'Virgin', photoColor: '#A35139', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/e9/b9/9e/e9b99e73-58a5-1e31-f57c-b11e78419dcf/16UMGIM86249.rgb.jpg/300x300bb.jpg' },

  // Ambient Works — Ambient / Experimental
  { id: 'nr-011', artist: 'Brian Eno', title: 'Ambient 1: Music for Airports', genre: 'Ambient', condition: 4, price: 52, qty: 1, storeId: 'store-004', storeName: 'Ambient Works', storeLocation: 'Portland, OR', format: '12"', year: 1978, label: 'Polydor', photoColor: '#EEE9DF', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music125/v4/ee/71/42/ee71425d-6bc9-3df8-c90b-8539f59144ab/00724386649553.rgb.jpg/300x300bb.jpg' },
  { id: 'nr-012', artist: 'Tim Hecker', title: 'Ravedeath, 1972', genre: 'Ambient', condition: 5, price: 35, qty: 2, storeId: 'store-004', storeName: 'Ambient Works', storeLocation: 'Portland, OR', format: '2x12"', year: 2011, label: 'Kranky', photoColor: '#4A5B6D', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music124/v4/4a/68/4c/4a684c10-456b-8442-9ed3-764d57a32aed/mzi.ukvgcwzt.jpg/300x300bb.jpg' },
  { id: 'nr-013', artist: 'Gas', title: 'Pop', genre: 'Ambient', condition: 4, price: 78, qty: 1, storeId: 'store-004', storeName: 'Ambient Works', storeLocation: 'Portland, OR', format: '3x12"', year: 2000, label: 'Mille Plateaux', photoColor: '#3D7A4F', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music115/v4/5d/6a/00/5d6a0054-5145-6011-c638-3e2666d0e8dd/192641833472_Cover.jpg/300x300bb.jpg' },
  ...
  { id: 'nr-021', artist: 'Larry Heard', title: 'Sceneries Not Songs', genre: 'House', condition: 4, price: 58, qty: 1, storeId: 'store-008', storeName: 'Crate Diggers Union', storeLocation: 'Chicago, IL', format: '2x12"', year: 1994, label: 'Black Market', photoColor: '#2C3B4D', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/c9/4b/ed/c94bedd8-5c5e-df56-1fb9-000a16537f01/8718723149693.jpg/300x300bb.jpg' },
  ...
  { id: 'nr-023', artist: 'Frankie Knuckles', title: 'Beyond the Mix', genre: 'House', condition: 5, price: 42, qty: 1, storeId: 'store-008', storeName: 'Crate Diggers Union', storeLocation: 'Chicago, IL', format: '12"', year: 1991, label: 'Virgin', photoColor: '#3D7A4F', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music6/v4/9d/65/21/9d6521c3-fc50-8d5a-6ddc-7628ff7d307f/05099909472952.jpg/300x300bb.jpg' },
  { id: 'nr-024', artist: 'Theo Parrish', title: 'First Floor', genre: 'House', condition: 4, price: 110, qty: 1, storeId: 'store-008', storeName: 'Crate Diggers Union', storeLocation: 'Chicago, IL', format: '3x12"', year: 1998, label: 'Peacefrog', photoColor: '#1B2632', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music/34/08/8f/mzi.dtxcmahx.tif/300x300bb.jpg' },
  { id: 'nr-025', artist: 'Moodymann', title: 'Silentintroduction', genre: 'House', condition: 4, price: 85, qty: 1, storeId: 'store-008', storeName: 'Crate Diggers Union', storeLocation: 'Chicago, IL', format: '2x12"', year: 1997, label: 'Planet E', photoColor: '#4A5B6D' },
]
...
export const swapProposals: SwapProposal[] = [
  {
    ...
    recordsYouSend: [
      ...
      { artist: 'Art Blakey', title: 'Moanin\'', genre: 'Jazz', condition: 3, marketValue: 42, photoColor: '#1B2632', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music114/v4/24/65/64/2465645a-7d7f-63a9-e0bb-097cdc6bd6a8/19UMGIM32054.rgb.jpg/300x300bb.jpg' },
    ...
    recordsYouReceive: [
      ...
      { artist: 'Drexciya', title: 'Neptune\'s Lair', genre: 'Electro', condition: 4, marketValue: 22, photoColor: '#2C3B4D', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music122/v4/95/a4/3f/95a43f9d-4eb9-e5a9-ee64-910d3fb95e6c/3663729188892_3000.jpg/300x300bb.jpg' },
    ],
    valueDelta: 25,
    mismatchScore: 94,
    marketSavings: 200,
  ...
  },
  {
    ...
    recordsYouSend: [
      { artist: 'Sade', title: 'Diamond Life', genre: 'R&B', condition: 4, marketValue: 35, photoColor: '#A35139', artworkUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Music115/v4/4d/d5/a1/4dd5a1b7-7134-f0ec-b55c-54ac47cc88a5/886448655886.jpg/300x300bb.jpg' },
