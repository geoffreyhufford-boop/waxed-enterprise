export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: 'Central source of truth. Multiple copies, graded conditions, variant pressings, private notes. Updates propagate to your storefront automatically. Fewer oversells and fewer refunds by running inventory and orders from one place.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Centralized dashboard. Order received → packed → shipped → delivered. Label generation and discounted rates replace the post office run. Supports local pickup alongside shipping workflows.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
