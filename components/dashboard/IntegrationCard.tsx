...
export default function IntegrationCard({ name, icon, status, lastSync }: Integration) {
  return (
    <div className="flex items-center justify-between py-3 px-4 rounded-xl hover:bg-waxe-card/50 transition-colors">
      <div className="flex items-center gap-3">
        <span className="w-8 h-8 rounded-lg bg-waxe-surface border border-waxe-border flex items-center justify-center text-sm">
          {icon}
        </span>
