    ...
    <div className="relative bg-waxe-card border-2 border-waxe-border rounded-none p-5 flex flex-col h-[360px] clip-card-bl">
      ...
      <div className="flex items-center justify-between mb-2 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[11px] text-waxe-text-muted uppercase tracking-[0.1em]">Last 7 months</p>
        ...
        <div className="text-right mr-11">
          ...
          <div className="flex items-center gap-1.5 justify-end mt-0.5">
            ...
            <p className="text-[11px] text-waxe-positive font-bold uppercase tracking-[0.1em]">+18% vs last month</p>
          </div>
        </div>
      </div>
          ...
          <AreaChart data={revenueData}>
            <defs>
              <linearGradient id="widgetOverviewRevenueGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#E89A40" stopOpacity={0.4} />
            ...
            <Area type="monotone" dataKey="revenue" stroke="#E89A40" fill="url(#widgetOverviewRevenueGrad)" strokeWidth={2.5} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
